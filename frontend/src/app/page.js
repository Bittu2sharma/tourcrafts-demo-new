                ...
                <Link href="/destinations" className="no-underline block">
                  <div className={`relative rounded-2xl overflow-hidden group cursor-pointer ${
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      <h3 className="text-white font-[Outfit] font-bold text-lg mb-1">{dest.name}</h3>
                      <div className="flex items-center justify-between">
                        <span className="text-white/70 text-xs">{dest.packages} Packages</span>
      ...
      <section className="section-padding relative overflow-hidden" style={{ background: 'var(--dark)' }}>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h2 className="section-title text-white">Why Choose <span className="text-[var(--secondary)]">Us?</span></h2>
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="btn-whatsapp !py-3.5 !px-8">
