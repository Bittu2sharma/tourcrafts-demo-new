      ...
      <Link href={`/blog/${blog.id}`} className="no-underline block">
        <div className="card group cursor-pointer h-full flex flex-col">
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            <h3 className="text-xl font-[Outfit] font-bold text-[var(--dark)] mb-3 group-hover:text-[var(--primary)] transition-colors leading-snug line-clamp-2">
              {blog.title}
            </h3>
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
              ...
              <span className="ml-auto text-sm font-semibold text-[var(--primary)] group-hover:underline">
                Read More →
              </span>
            </div>
          </div>
